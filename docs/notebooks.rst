...
In this section we give some explicit examples using \texttt{cryptomite} on recent experimental quantum cryptography demonstrations.
...
.. toctree::
    ...
    ../examples/quantum-key-distribution.ipynb
    ../examples/quantum-random-number-generation.ipynb
